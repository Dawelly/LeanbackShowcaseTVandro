 ...
 */
public class GridExampleFragment extends BrowseFragment {
    ...
    private void setupUi() {
        ...
        setTitle(getString(R.string.card_examples_title3));
    ...
    private void createRows() {
        String json = Utils
                .inputStreamToString(getResources().openRawResource(R.raw.grid_example));
